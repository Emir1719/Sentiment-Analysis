class StopWords:
    ...
    def __generateTurkishWords(self) -> list[str]:
        return [
            ...
            "biri", "hep", "biz", "sen", "onlar", "aslında", "ama", "fakat", "selam", "naber", "hoca", "hocam"
            ...
            "sin", "sın", "sun", "sün", "prof", "dr", "doc", "kere", "inşallah", "çok", "cok", "ise", "ın",
            "an", "la", "im", "vs", "yada", "l", "s", "ım", "tl", "bn", "çox", "c", "ben", "allah", "olsun"
            "var"
        ]